...
demigUS1950 <- dplyr::mutate(dplyr::group_by(demigUS1950, year), mag_score = numeric_change_restrict * numeric_change_level)
...
demigUS1950_ref <- dplyr::filter(demigUS1950, pol_area != "Exit", target_group == "Refugees, asylum seekers and other vulnerable people")
...
refugee_mag_score <- select(dplyr::filter(ungroup(demigUS1950), target_group == "Refugees, asylum seekers and other vulnerable people"), mag_score)
